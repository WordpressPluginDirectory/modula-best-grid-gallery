...
class Modula_Uninstall {
	...
	public function modula_uninstall_plugin() {
		...
		if ( '1' == $uninstall_option['delete_options'] ) {
			...
			$options_array = apply_filters( 'modula_uninstall_db_options', array( 'modula_troubleshooting_option', 'modula_debug_log', 'modula-checks', 'modula_version', 'widget_modula_gallery_widget', 'modula-rate-time', 'modula_modern_beta', 'modula_beta_gallery_migrated' ) );
